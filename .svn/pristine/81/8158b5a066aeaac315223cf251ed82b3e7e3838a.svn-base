					...
					<h1 class="text-center">PROFILE CHANGE</h1>
              			...
              			<div class="form-group">
              	 			<label class="control-label col-sm-2">PASSWORD</label>
               					...
               					<div class="pwchange col-sm-2">
                        			<button class="btn btn-danger" type="button">변경</button>
                    			</div>
              			</div>
              			<div class="form-group">
              	 			<label class="control-label col-sm-2">email</label>
               					<div class="col-sm-9">
                  					<input type="text" class="change-email form-control" />
               					</div>
              			</div>
              			<div class="form-group">
              			...
              			<div class="form-group">
              				<label class="control-label col-sm-2" >주민번호</label>
              					<div class="col-sm-4">
                  					...
                  					<div class="col-sm-5">
                  						<a type="password" class="form-control" disabled="disabled" /></a>
                  					</div>
              			</div>
						<div class="form-group text-right font-size:20px">
							<div class="col-sm-11 font-size-large">
								...
								<button class="btn btn-info" type="button">메인페이지</button>
							</div>
						</div>
				</form>
			</div>
