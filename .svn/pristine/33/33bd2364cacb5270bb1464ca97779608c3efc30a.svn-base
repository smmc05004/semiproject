        ...
        <div class="row well">
            <div class="col-sm-4">
                ...
                <div class="img-file" style="margin-top: 95px ">
                    ...
                    <input type="file" class="form-control" id="submit-upload">
                </div>
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="submit-title">
               </div>
               
                <div class="form-group">
                    <label for="submit-news" style="display: none;"></label>
                    <select name="" id="submit-news" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="" id="submit-category" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select name="" id="submit-nation" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <textarea name="" id="submit-contents" cols="10" rows="5" class="form-control"></textarea>
                </div>
                
                <div class="form-group">
                    <label for="submit-day" style="display: none;">작성일</label>
                    <input type="date" class="form-control" id="submit-dat">
                </div>
                
                <div class="form-group">
                    <label for="submit-writer" style="display: none;">작성자</label>
                    <input type="text" class="form-control" id="submit-writer" disabled>
                </div>
            </div>
